...
export class UIManager extends EventEmitter {
   ...
   */
  public animateDrawingToHistory(drawing: DrawingData, attemptNumber: number): void {
  ...
  public cleanupAnimations(): void {
    ...
    if (this.components.container) {
      const tempElements = this.components.container.querySelectorAll('.animate-to-corner, .animate-to-history');
