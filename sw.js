...
}, k = (s) => [d.prefix, s, d.suffix].filter((e) => e && e.length > 0).join("-"), Y = (s) => {
...
class he {
  ...
  async cachePut(e, t) {
    ...
    if (!r)
      return !1;
    const { cacheName: i, matchOptions: c } = this._strategy, o = await self.caches.open(i), h = this.hasCallback("cacheDidUpdate"), m = h ? await ie(
...
class le {
  ...
  addToCacheList(e) {
    ...
    for (const n of e) {
      ...
      const { cacheKey: a, url: r } = ee(n), i = typeof n != "string" && n.revision ? "reload" : "default";
...
let w;
const V = () => (w || (w = new de(), w.addFetchListener(), w.addCacheListener()), w);
function v(s, e, t) {
  let n;
  if (typeof s == "string") {
...
class Te extends E {
  ...
  async _handle(e, t) {
    ...
    try {
      ...
      if (this._networkTimeoutSeconds) {
        const i = F(this._networkTimeoutSeconds * 1e3);
        r.push(i);
      }
...
const G = /* @__PURE__ */ new WeakMap(), U = /* @__PURE__ */ new WeakMap(), Q = /* @__PURE__ */ new WeakMap(), D = /* @__PURE__ */ new WeakMap(), I = /* @__PURE__ */ new WeakMap();
function Ue(s) {
...
function Ie(s) {
  return s === IDBDatabase.prototype.transaction && !("objectStoreNames" in IDBTransaction.prototype) ? function(e, ...t) {
    ...
    return s.apply(L(this), e), f(G.get(this));
  } : function(...e) {
    return f(s.apply(L(this), e));
  };
}
function Se(s) {
  return typeof s == "function" ? Ie(s) : (s instanceof IDBTransaction && Ne(s), De(s, Le()) ? new Proxy(s, N) : s);
}
function f(s) {
...
const Ae = ["get", "getKey", "getAll", "getAllKeys", "count"], Oe = ["put", "add", "delete", "clear"], P = /* @__PURE__ */ new Map();
function W(s, e) {
  ...
  if (
    ...
    !(t in (n ? IDBIndex : IDBObjectStore).prototype) || !(a || Ae.includes(t))
  )
    return;
...
const We = "workbox-expiration", y = "cache-entries", B = (s) => {
...
class Be {
   ...
   */
  async getDb() {
    return this._db || (this._db = await Me(We, 1, {
...
class je {
   ...
   */
  constructor(e, t = {}) {
    this._isRunning = !1, this._rerunRequested = !1, this._maxEntries = t.maxEntries, this._maxAgeSeconds = t.maxAgeSeconds, this._matchOptions = t.matchOptions, this._cacheName = e, this._timestampModel = new Be(e);
  }
  /**
...
_e();
be([{"revision":null,"url":"assets/game-B-G7AtkA.js"},{"revision":null,"url":"assets/index--N4flfum.js"},{"revision":null,"url":"assets/index-C_pJuK1s.css"},{"revision":null,"url":"assets/vendor-DbEQ4MDT.js"},{"revision":"0154f3154359d680e8eaebd6c873bf7f","url":"index.html"},{"revision":"1872c500de691dce40960bb85481de07","url":"registerSW.js"},{"revision":"cb91a42bdbeaa3fe024352ea667c809f","url":"favicon.svg"},{"revision":"8c9e4b83d66ab4d1d642b1c95c0a5448","url":"pwa-192x192.png"},{"revision":"c1b79d80a55f5611320f5534a13ee7e4","url":"pwa-512x512.png"},{"revision":"9b38a39a0b2c4ffa8d41e9c175afe998","url":"manifest.webmanifest"}]);
v(
...
v(
  ({ request: s }) => s.destination === "image" || s.destination === "font",
  new xe({
...
self.addEventListener("error", (s) => {
  console.error("Service Worker error:", s.error);
});
self.addEventListener("unhandledrejection", (s) => {
  console.error("Service Worker unhandled rejection:", s.reason);
});
self.addEventListener("install", (s) => {
  console.log("Service Worker installing."), s.waitUntil(self.skipWaiting());
});
self.addEventListener("activate", (s) => {
  console.log("Service Worker activated."), s.waitUntil(self.clients.claim());
});
